...
![mvvsデモ](./gif/mvte_demo01.gif)

![mvvsデモ](./gif/mvte_demo02.gif)
...
ツクールMVで変数選択画面を表示してください。

この時、本ソフトを常に全面に表示したい場合は、検索欄の隣のボタンをクリックしてく
ださい。
...
ツクール側で使用したいデータをダブルクリック、またはEnterキーを押してください。
